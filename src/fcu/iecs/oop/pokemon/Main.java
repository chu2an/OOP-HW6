...
public class Main {
	  ...
	  public static void main(String[] args) {
	    ...
	    Player champ=GYM.fight(player1, player2);
	    champ.setLevel(champ.getLevel()+1);
	    System.out.println("The winner is "+champ.getPlayerName()+", and his/her level becomes "+champ.getLevel()+" !");
